<template>
  ...
  <div class="content_sign">
    <el-card class="box-card">
        ...
        <el-row>
          <el-col :span="6"><div class="grid-content bg-purple">
            <el-form-item label="合同名称:">
              <el-input v-model="seachData.name" placeholder="请输入合同名称" clearable />
            </el-form-item>
          </div></el-col>
      ...
      <div class="add_box">
        <el-button type="primary" @click="addFun">新增合同</el-button>
      </div>
      ...
      >
        ...
        <el-table-column label="合同名称" width="150px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.timestamp | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
          </template>
        </el-table-column>
        <el-table-column label="关联角色" min-width="150px">
          <template slot-scope="{row}">
